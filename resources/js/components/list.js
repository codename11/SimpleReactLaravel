    ...
    render(){
        ...
        return (
            <div>
                ...
                {(videos && videos.length > 0 && this.state.offset<this.state.videos.length) ? <a href="#"  className='showMore btn btn-outline-info' onClick={this.offsetIncrement}>Show more...</a> : <div className="showMore"></div>}
